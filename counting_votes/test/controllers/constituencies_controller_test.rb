...
class ConstituenciesControllerTest < ActionController::TestCase
  ...
  test "should create constituency" do
    assert_difference('Constituency.count') do
      post :create, constituency: { authorized_number: @constituency.authorized_number, empty_votes: @constituency.empty_votes, given_cards: @constituency.given_cards, mandate_number: @constituency.mandate_number, many_votes: @constituency.many_votes, number: @constituency.number, other_votes: @constituency.other_votes, returned_cards: @constituency.returned_cards, voivodeship_id: @constituency.voivodeship_id }
    end
